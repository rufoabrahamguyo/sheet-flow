    ...
    setupBusEventListeners() {
        ...
        onBus('mongosh:evaluate-input', (args) => {
            if ((0, mongodb_redact_1.shouldRedactCommand)(args.input)) {
                this.log.info('MONGOSH', (0, mongodb_log_writer_2.mongoLogId)(1000000007), 'repl', 'Evaluating input', { input: '<sensitive command used>' });
                return;
            }
        ...
        onBus('mongosh:api-call-with-arguments', (args) => {
            ...
            this.log.info('MONGOSH', (0, mongodb_log_writer_2.mongoLogId)(1000000011), 'shell-api', 'Performed API call', (0, mongodb_redact_1.redact)(arg));
        });
        ...
        onBus('mongosh-editor:run-edit-command', (ev) => {
            this.log.error('MONGOSH-EDITOR', (0, mongodb_log_writer_2.mongoLogId)(1000000047), 'editor', 'Open external editor', (0, mongodb_redact_1.redact)(ev));
        });
