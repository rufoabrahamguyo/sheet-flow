    ...
    var Collection = _classThis = class extends _classSuper {
                ...
                for (const fieldName of Object.keys(shardStorageStats)) {
                    ...
                    if ([
                        ...
                        if (typeof shardTimeseriesStats.bucketsNs === 'string')
                            timeseriesBucketsNs !== null && timeseriesBucketsNs !== void 0 ? timeseriesBucketsNs : (timeseriesBucketsNs = shardTimeseriesStats.bucketsNs);
        ...
        async _getShardedCollectionInfo(config, collStats) {
            ...
            const timeseriesBucketNs = collStats
                .map((extractedShardStats) => { var _a, _b; return (_b = (_a = extractedShardStats.storageStats) === null || _a === void 0 ? void 0 : _a.timeseries) === null || _b === void 0 ? void 0 : _b.bucketsNs; })
