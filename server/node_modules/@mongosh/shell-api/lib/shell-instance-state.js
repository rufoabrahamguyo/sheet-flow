...
class ShellInstanceState {
            ...
            assignMetadata: (target, { help, maxVersion, minVersion, deprecated }) => {
                target.serverVersions =
                    maxVersion || minVersion
                        ? [
                            minVersion !== null && minVersion !== void 0 ? minVersion : enums_1.ServerVersions.earliest,
                            maxVersion !== null && maxVersion !== void 0 ? maxVersion : enums_1.ServerVersions.latest,
                        ]
    ...
    async fetchConnectionInfo() {
        ...
        if (!this.cliOptions.nodb) {
            ...
            this.messageBus.emit('mongosh:connect', {
                ...
                uri: (0, mongodb_redact_1.redactConnectionString)((_b = (_a = connectionInfo === null || connectionInfo === void 0 ? void 0 : connectionInfo.extraInfo) === null || _a === void 0 ? void 0 : _a.uri) !== null && _b !== void 0 ? _b : ''),
            });
        ...
        return {
            topology: () => {
                ...
                switch (topologyType) {
                    ...
                    default:
                        topology = 'Standalone';
                        if (((_a = topologyDescription === null || topologyDescription === void 0 ? void 0 : topologyDescription.servers) === null || _a === void 0 ? void 0 : _a.size) === 1) {
    ...
    async getTopologySpecificPrompt() {
        ...
        switch (description.type) {
            case 'Single': {
                ...
                replicaSet = (_a = singleDetails === null || singleDetails === void 0 ? void 0 : singleDetails.replicaSet) !== null && _a !== void 0 ? _a : replicaSet;
            ...
            case 'ReplicaSetWithPrimary':
                ...
                break;
            case 'Sharded':
                serverTypePrompt = ((_b = connectionInfo === null || connectionInfo === void 0 ? void 0 : connectionInfo.extraInfo) === null || _b === void 0 ? void 0 : _b.atlas_version)
                    ? ''
                    : '[mongos]';
                break;
            case 'LoadBalanced':
    ...
    getTopologySinglePrompt(description) {
        ...
        return {
            replicaSet: (_c = (_b = server.setName) !== null && _b !== void 0 ? _b : description.setName) !== null && _c !== void 0 ? _c : null,
            serverType,
        };
    }
