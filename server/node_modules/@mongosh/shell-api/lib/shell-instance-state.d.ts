import type { AutoEncryptionOptions, ConnectionExtraInfo, ConnectionInfo, ServerApi, ServiceProvider, ServiceProviderBaseCursor } from '@mongosh/service-provider-core';
...
import { type ShellBson, type BSON as BSONLibrary } from '@mongosh/shell-bson';
...
export declare class ShellInstanceState {
    ...
    constructor(initialServiceProvider: ServiceProvider, messageBus?: any, cliOptions?: ShellCliOptions, bsonLibrary?: BSONLibrary);
