...
class CliRepl {
    constructor(options) {
        ...
        const deepInspect = (_c = this.cliOptions.deepInspect) !== null && _c !== void 0 ? _c : willEnterInteractiveMode;
        this.mongoshRepl = new mongosh_repl_1.default({
            ...options,
            shellCliOptions: { ...this.cliOptions, jsContext, quiet, deepInspect },
            nodeReplOptions: (_d = options.nodeReplOptions) !== null && _d !== void 0 ? _d : {
